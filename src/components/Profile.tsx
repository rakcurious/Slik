...
function Profile() {
  ...
  return (
    <div className="h-auto w-screen flex flex-col justify-start items-center bg-violet-100">
      <div className="z-10 sticky bg-transparent top-20 h-12 w-auto flex justify-center items-center gap-1 md:gap-5 mt-0 -m-16 px-2 md:px-6 rounded-3xl  ring-2 ring-violet-200">
